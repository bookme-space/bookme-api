...
> {
  ...
  public abstract run<R, TArgs extends any[]>(
...
export class Als<K = unknown, V = unknown>
  implements IAls<K, V>
{
  constructor(
    protected readonly als: AsyncLocalStorage<Map<K, V>>,
  ) {}
